...
| [content/robin-li/stable_replies.json](content/robin-li/stable_replies.json)、[说明与文稿](content/robin-li/stable_replies.md) | 数字人交互、应用驱动两组精简文稿；原问与预设改写直出，新问法按语义分类选择，命中后不再生成改写 |
